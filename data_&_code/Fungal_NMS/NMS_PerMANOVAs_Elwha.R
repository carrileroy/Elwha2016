...
with(second, legend("topleft", legend = levels(region), bty = "n", col = colvec, pch = shpvec, pt.bg = colvec))
ordihull(bray.ord, groups = second$region, label = FALSE, col = colvec)
plot(bray.ord.SimpF, add = TRUE, cex=1.5)
plot(bray.ord.DivF, add = TRUE, cex=1.5)
plot(bray.ord.RichF, add = TRUE, cex=1.5)
plot(bray.ord.EvenM, add = TRUE, cex=1.5)
plot(bray.ord.DivM, add = TRUE, cex=1.5)
plot(bray.ord.SimpsonM, add = TRUE, cex=1.5)

# Add significant Sediment vectors to plot
colvec <- c("red1","orange2", "gold", "green1", "blue1", "purple1")
shpvec <- c(16, 15, 16, 15, 16, 15)
plot(bray.ord, type = "n", choices=c(1,2), cex.lab=1.5, cex.axis=1.3)
with(second, points(bray.ord, display = "sites", cex=1.5, col = colvec[region], pch = shpvec[region], bg = colvec[region]))
with(second, legend("topleft", legend = levels(region), bty = "n", col = colvec, pch = shpvec, pt.bg = colvec))
ordihull(bray.ord, groups = second$region, label = FALSE, col = colvec)
plot(bray.ord.Sed2, add = TRUE, cex=1.5)
plot(bray.ord.Sed3, add = TRUE, cex=1.5)
plot(bray.ord.P2, add = TRUE, cex=1.5)
plot(bray.ord.P7, add = TRUE, cex=1.5)
plot(bray.ord.P8, add = TRUE, cex=1.5)
...
with(second, legend("topleft", legend = levels(region), bty = "n", col = colvec, pch = shpvec, pt.bg = colvec))
ordihull(bray.ord, groups = second$region, label = FALSE, col = colvec)
plot(bray.ord.Depth, add = TRUE, cex=1.5)
plot(bray.ord.CC, add = TRUE, cex=1.5)
plot(bray.ord.Chla, add = TRUE, cex=1.5)
plot(bray.ord.MaxT, add = TRUE, cex=1.5)
...
plot(bray.ord.P, add = TRUE, cex=1.5)
plot(bray.ord.SiO4, add = TRUE, cex=1.5)
